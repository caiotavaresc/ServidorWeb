...
final class HttpRequest implements Runnable
{
    ...
    private void processRequest() throws Exception
    {
        ...
        //Se a linha de requisicao for nula - encerrar a thread
        if(requestLine == null)
            return;
            ...
            for (int i=0; i<ServidorWeb.diretoriosAutenticados.size();i++){
                    if(diretorio.getPath().contains(ServidorWeb.diretoriosAutenticados.get(i))){
                        ...
                        if(Authorization.length()==0){
                            ...
                            contentTypeLine = "WWW-Authenticate: Basic realm=\"Conteudo restrito - informe as credenciais\"" + CLRF;
                    ...
                    switch(ServidorWeb.opcaoDiretorio)
                    {
                        ...
                        case 3:
                            ...
                            nomeArq = diretorio.getPath()+"/index.html";
                                ...
                                //Se o arquivo index.html nao existir no diretorio, enviar a mensagem de conteudo indisponivel
